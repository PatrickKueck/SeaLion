...
my	%value_of_scr_par	=	(
	...
	'sys_parameter'		=>	{
							...
							'outgroup'					=>	'Out'						,	# SeaLion parameter: specified code of defined outgroup-clan in clan-infile
							...
							'pen_bin'					=>	'sealion1.0_usr.version.pl'	,	# SeaLion parameter: actual penguin script name
