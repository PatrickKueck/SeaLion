...
my	%value_of_scr_par	=	(
	...
	'sys_parameter'		=>	{
							...
							'pen_bin'					=>	'sealion1.023.pl'			,	# SeaLion parameter: actual penguin script name
...
sub evaluation_otu_support_main{ # changed 15.04.25 
...
sub generate_species_quartets{ # changed 15.04.25
...
sub check_site_states{ # added 15.04.25
...
sub plotsR_quartet_analyses{ # changed 15.04.25
...
sub print_tsv_MQ7{	# added 15.04.25
...
sub print_tsv_Q5_Q8{ # changed 15.04.25
...
sub print_tsv_T9{ # added 15.04.25
...
sub quartet_building_and_p4_main{ # changed 15.04.25
